...
export default async function deleteModules(
...
async function deleteContentScript(manifestObject: chrome.runtime.ManifestV3) {
  await zipFolder(
    resolve(pagesPath, 'content'),
    resolve(archivePath, 'content.zip'),
  )
...
async function deleteContentScriptUI(
  manifestObject: chrome.runtime.ManifestV3,
) {
  await zipFolder(
    resolve(pagesPath, 'content-ui'),
    resolve(archivePath, 'content-ui.zip'),
  )
...
async function deleteContentScriptRuntime(
  manifestObject: chrome.runtime.ManifestV3,
) {
  await zipFolder(
...
async function deleteNewTabOverride(manifestObject: chrome.runtime.ManifestV3) {
  await zipFolder(
    resolve(pagesPath, 'new-tab'),
    resolve(archivePath, 'new-tab.zip'),
  )
...
async function deletePopup(manifestObject: chrome.runtime.ManifestV3) {
  await zipFolder(
    resolve(pagesPath, 'popup'),
    resolve(archivePath, 'popup.zip'),
  )
...
async function deleteDevTools(manifestObject: chrome.runtime.ManifestV3) {
  await zipFolder(
    resolve(pagesPath, 'devtools'),
    resolve(archivePath, 'devtools.zip'),
  )
  await zipFolder(
    resolve(pagesPath, 'devtools-panel'),
    resolve(archivePath, 'devtools-panel.zip'),
  )
...
async function deleteSidePanel(manifestObject: chrome.runtime.ManifestV3) {
  await zipFolder(
    resolve(pagesPath, 'side-panel'),
    resolve(archivePath, 'side-panel.zip'),
  )
...
async function deleteOptionsPage(manifestObject: chrome.runtime.ManifestV3) {
  await zipFolder(
    resolve(pagesPath, 'options'),
    resolve(archivePath, 'options.zip'),
  )
